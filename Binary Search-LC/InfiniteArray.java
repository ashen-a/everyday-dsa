...
// CAN'T USE array.length function

// CONCEPT : -- Move in chunks
//           -- Search space should increase in proportion to reverse Binary Search pattern
//           -- For the worst case total cases = log(N)

public class InfiniteArray {
    // Reverse the logic of Binary Search
